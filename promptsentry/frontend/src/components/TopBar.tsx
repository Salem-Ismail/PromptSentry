  ...
  return (
    <header className="flex shrink-0 flex-wrap items-center gap-3 border-b border-[var(--border)] bg-[rgba(10,14,20,0.65)] px-5 py-2.5 backdrop-blur-xl">
      <div className="flex items-center gap-2">
        <span className="rounded-md border border-[var(--border)] bg-white/[0.02] px-2.5 py-1 text-[12px] tracking-[0.08em] text-[var(--muted)] uppercase">
          Local
        </span>
        <span
          className={`inline-flex items-center gap-2 rounded-full border px-2.5 py-1 text-[12px] font-medium tracking-wide ${statusClass}`}
        >
